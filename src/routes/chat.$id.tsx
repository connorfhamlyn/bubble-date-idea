      ...
      <div className="min-h-dvh flex flex-col">
        ...
        <div className="flex-1 grid place-items-center p-6 text-center">
          <div>
            ...
            <p className="font-semibold mt-3">Chat unlocks once both sides accept.</p>
            <p className="text-sm text-muted-foreground mt-1">Keep it on Plotted until then.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-background">
      ...
      <form onSubmit={send} className="border-t border-border bg-background px-3 py-2 safe-bottom flex gap-2">
        ...
        <button className="w-11 h-11 grid place-items-center rounded-full bg-primary text-primary-foreground shadow-bubble" aria-label="Send">
