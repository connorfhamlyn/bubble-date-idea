...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Motif — date ideas, on the map" },
      { name: "description", content: "Post a date idea at a real venue. Connect with people who want to go." },
      { name: "author", content: "Motif" },
      { property: "og:title", content: "Motif — date ideas, on the map" },
      { property: "og:description", content: "Post a date idea at a real venue. Connect with people who want to go." },
